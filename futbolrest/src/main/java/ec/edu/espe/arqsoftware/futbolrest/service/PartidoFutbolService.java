 ...
 */
package ec.edu.espe.arqsoftware.futbolrest.service;

import ec.edu.espe.arqsoftware.futbolrest.dao.PartidoFutbolRepository;
import ec.edu.espe.arqsoftware.futbolrest.exception.CreateException;
...
public class PartidoFutbolService {
    ...
    public List<PartidoFutbol> obtenerPartidosDisponibles() {
        return this.partidoFutbolRepo.findByDateBetween();
    }
